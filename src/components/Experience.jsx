...
function Experience({values, onChange, onRemove}) {
    return (
        <section className="experience-info">
            ...
            <TextArea label="Responsibilities" name="responsibilities" className="full-width" value={values["responsibilities"]} onChange={onChange} placeholder="Describe your responsibilities briefly (one per line)"/>
